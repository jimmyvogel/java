...
//Rmq: pour éviter les possibles conflits, on nomme les modules selon le package par convention
module modularisation.sameClassProvided.com.jv.sameClass {
    exports com.jv.sameClass;
}