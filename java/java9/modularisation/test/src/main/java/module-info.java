...
*/
module test {
    requires modularisation.com.jv.visibility;
    requires /*static*/ modularisation.sameClassProvided.com.jv.sameClass;

    //Can't be add because in runtime maven mode
    //requires modularisation.sameClassRuntime.com.jv.sameClass;
}